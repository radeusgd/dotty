object Test extends App {
  ...
  val t1 = x1.tail; val t1c: Tuple0 = t1; println(s"t1 = $t1")
  val t2 = x2.tail; val t2c: Int *: Tuple0 = t2; println(s"t2 = $t2")
  ...
  val c0_0 = x0 ++ x0; val c0_0c: Tuple0 = c0_0; println(s"c0_0 = $c0_0")
  val c0_1 = x0 ++ x1; val c0_1c: Int *: Tuple0 = c0_1c; println(s"c0_1 = $c0_1")
  val c1_0 = x1 ++ x0; val c1_0c: Int *: Tuple0 = c1_0c; println(s"c1_0 = $c1_0")
...
// dynamic operations
  ...
  val conc1: (String, Int) = concat(Tuple0(), tl1)
  val conc2: (String, Int) = concat(tl1, Tuple0())
  val conc3: (String, Int, String, Int) = concat(tl1, tl1)
  val conc4: (String, Int) = concat0(Tuple0(), tl1)
  val conc5: (String, Int) = concat0(tl1, Tuple0())
  ...
  val x3s0: 3 = size(x3)
  val us0: 0 = size(Tuple0())
  val x3s1: 3 = size0(x3)
  val us1: 0 = size0(Tuple0())
}
