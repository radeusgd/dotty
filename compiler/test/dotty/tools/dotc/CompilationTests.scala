...
class CompilationTests extends ParallelTesting {
  ...
  @Test def pos: Unit = {
    ...
    aggregateTests(
      ...
      compileFilesInDir("tests/pos-custom-args/escape-analysis", TestFlags(basicClasspath, commonOptions.filter(_ != "-Ycheck:all")).and("-Yescape-analysis")),
  ...
  @Test def negAll: Unit = {
    ...
    aggregateTests(
      ...
      compileFilesInDir("tests/neg-custom-args/escape-analysis", TestFlags(basicClasspath, commonOptions.filter(_ != "-Ycheck:all")).and("-Yescape-analysis")),
