...
class CompilationTests extends ParallelTesting {
  ...
  @Test def pos: Unit = {
    ...
    aggregateTests(
      ...
      compileFilesInDir("tests/pos-custom-args/retain-trees", TestFlags(basicClasspath, commonOptions.filter(_ != "-Ycheck:all")).and("-Yretain-trees")),
  ...
  @Test def negAll: Unit = {
    ...
    aggregateTests(
      ...
      compileFilesInDir("tests/neg-custom-args/retain-trees", TestFlags(basicClasspath, commonOptions.filter(_ != "-Ycheck:all")).and("-Yretain-trees")),
